...
<body data-spy="scroll" data-target=".navbar" data-offset="50">
 ...
 <h2>Juan David Gomez</h2>  </div>
      <br>
      <img src="img/profile1.jpg" alt="juan" class="img-circle">
  ...
  <div class="container-fluid text-center  " id="skills">
    ...
    <div class="row">
      <h2><strong>CURRENT SKILLS</strong> </h2>
      <p >
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. A repellendus ratione, quo expedita doloribus dolorum asperiores doloremque quibusdam quia neque accusamus veniam, quas molestiae consequuntur nesciunt hic maiores. Iure, beatae.
      </p>
      ...
      <div class="col-sm-6 col-xs-12 ">
        ...
        <form action="/action_page.php" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" for="name" class="form-control greybackground" id="name" placeholder="Type your name">
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-2" for="email">Email</label>
            <div class="col-sm-10">
              <input type="email" name="email" class="form-control greybackground" id="email" placeholder="Enter email:">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea class="form-control greybackground" rows="5" id="message"></textarea>
            </div>
          </div>
          <div class="form-group">
      ...
      <div class="col-sm-6 col-xs-12">
        ...
        <div class="row">
          <div class="col-sm-8 col-sm-offset-2" style="text-align:center">
            <p>
              <a href=""><span class="glyphicon glyphicon-earphone"></span></a>+0406829636</p>
          </div>
        </div>
